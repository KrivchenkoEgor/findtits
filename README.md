...
**Учебный проект: кастомная YOLO11 модель для бинарной детекции объектов**
...
Учебный пример тренировки кастомной модели **YOLO11n** (nano) для задачи бинарной детекции. Модель обучена на **367 изображениях** и определяет один класс объектов.

Основная цель — показать полный цикл обучения YOLO на собственном датасете:
